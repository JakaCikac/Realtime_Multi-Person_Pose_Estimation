...
function(caffe_pickup_caffe_sources root)
  ...
  #caffe_source_group("Include"        GLOB "${root}/include/rtpose/*.h*")
  ...
  #caffe_source_group("Source"         GLOB "${root}/src/rtpose/*.cpp")
  ...
  #file(GLOB_RECURSE hdrs ${root}/include/rtpose/*.h*)
  file(GLOB_RECURSE srcs ${root}/src/caffe/*.cpp)
  #file(GLOB_RECURSE srcs ${root}/src/rtpose/*.cpp)
